...
function storyScript(){
	switch(scount){
		...
		case 1: setTimeout(createChat, 3000, 'It\'s the 22nd of may, 2018 today isn\'t it?', 'dpic.png', 'Elfinlox');
				scount++;	
			break;
		case 2: setTimeout(createChat, 2000, 'Well listen, I may have just met you but I had a vision from the future that I feel I must share with you.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		...
		case 5: setTimeout(createChat, 1500, 'Wonder if you think that\'s creepy? Wouldn\'t blame you if you did.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		case 6: setTimeout(createChat, 3000, 'Well from what i saw, looks like in a few months we\'ll begin talking to each other everyday, often for hours.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		...
		case 9: setTimeout(createChat, 3000, 'Pretty commonplace, eh?', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		case 10: setTimeout(createChat, 2000, 'Well what\'s not common is how long it apparently will stick around. And it sure was a long time in the vision.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		case 11: setTimeout(createChat, 3500, 'I also saw that I will write a few poems for you.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		case 12: setTimeout(createChat, 5500, 'With the third one being the best. Can\'t wait to find out what that\'s gonna be about.', 'dpic.png', 'Elfinlox');
				scount++;
			break;
		case 13: setTimeout(createChat, 1500, 'Oh yeah, we will also celebrate your birthday together. When\'s your birthday anyway?', 'dpic.png', 'Elfinlox');
				scount++;
			break;
